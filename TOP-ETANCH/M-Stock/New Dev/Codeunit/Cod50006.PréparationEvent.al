...
*/
        ...
        If (DocumentType = DocumentType::Facture) or (DocumentType = DocumentType::Commande) then begin
            ...
            if incount > 0 then begin
                if incount > 1 then
                    Message('%1 bons de préparation ont été créés avec succés', incount)
                else
    ...
    var
        OrdrePréparation: record "Ordre de preparation";
        LignePréparation: record "Ligne préparation";
    ...
    begin
        ...
        if "OrdrePréparation"."document type" = "OrdrePréparation"."document type"::Transfert then begin
            TransfertLine.setrange("Document No.", "OrdrePréparation"."Order No");
            if TransfertLine.findfirst then
                repeat
        ...
        ("OrdrePréparation"."document type" = "OrdrePréparation"."document type"::Commande) then begin
