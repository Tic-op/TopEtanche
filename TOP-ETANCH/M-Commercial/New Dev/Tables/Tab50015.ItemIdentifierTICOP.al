table 50017 "Item Identifier TICOP"

{
    Caption = 'Item Identifier 2';
    DataCaptionFields = "Code", "Item No.";
    DrillDownPageID = "Item identifier Ticop List";
    LookupPageID = "Item identifier Ticop List";
...
#pragma warning restore AA0074
    ...
    var
        ItemIdent: Record "Item Identifier TICOP";
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    local procedure OnBeforeVerifyItem(ItemIdentifier: Record "Item Identifier TICOP"; var IsHandled: Boolean)
    begin
    end;
}
